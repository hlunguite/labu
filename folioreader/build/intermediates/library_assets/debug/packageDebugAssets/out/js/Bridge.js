...
function getBodyText() {
    ...
    //clearSelection();
    //FolioPageFragment.shareContent(selectedText);
//console.log("Innerhtml " + document.body.innerHTML);
    // FolioPageFragment.shareContent(document.body.innerText);
    FolioPageFragment.shareContent(document.body.innerHTML);
...
//console.log("Innerhtml " + document.body.innerHTML);
    // FolioPageFragment.shareContent(document.body.innerText);
    EpubReader.htmlContent(document.body.innerHTML);
...
$(function () {
    window.ssReader = Class({
        ...
        init: function () {
            ...
            this.highlighter.addClassApplier(rangy.createClassApplier("normal", {
                 ignoreWhiteSpace: true,
                  tagNames: ["span", "a"]
                  }));
        },
...
function constructDOMRect(rectJsonString) {
  ...
  return {
            left: rectJson.left,
            top: rectJson.top,
            right: rectJson.right,
            bottom: rectJson.bottom
        };	
