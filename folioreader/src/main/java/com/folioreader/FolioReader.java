...
public class FolioReader {
    ...
    public static final String SONG_NUMBER = "com.folioreader.extra.SONG_NUMBER";
    ...
    public FolioReader openBook(String assetOrSdcardPath, int songindex  ) {
        Intent intent = getIntentFromUrl(assetOrSdcardPath, 0, songindex);
        context.startActivity(intent);
        return singleton;
    }

    public FolioReader openBook(int rawId) {
        Intent intent = getIntentFromUrl(null, rawId, -1);
        context.startActivity(intent);
        return singleton;
    }

    public FolioReader openBook(String assetOrSdcardPath, String bookId) {
        Intent intent = getIntentFromUrl(assetOrSdcardPath, 0, -1);
    ...
    private Intent getIntentFromUrl(String assetOrSdcardPath, int rawId, int songindex) {
    ...
    public FolioReader readBook(String assetOrSdcardPath ) {
