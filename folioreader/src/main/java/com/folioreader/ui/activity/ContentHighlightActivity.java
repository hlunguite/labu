...
import com.folioreader.ui.fragment.GridTOCGragment;
...
public class ContentHighlightActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        UiUtil.setColorIntToDrawable(mConfig.getThemeColor(), ((ImageView) findViewById(R.id.btn_grid)).getDrawable());
        UiUtil.setColorIntToDrawable(mConfig.getThemeColor(), ((ImageView) findViewById(R.id.btn_sort)).getDrawable());
    ...
    private void loadContentFragment() {
        ...
        findViewById(R.id.btn_grid).setVisibility(View.VISIBLE);
        FragmentTransaction ft = getSupportFragmentManager().beginTransaction();

        if (mIsGrid) {
            GridTOCGragment gridFragmentLayout = GridTOCGragment.newInstance(publication,getIntent().getStringExtra(Constants.CHAPTER_SELECTED),
                    getIntent().getStringExtra(Constants.BOOK_TITLE));
            gridFragmentLayout.setAscending(ascending);
            ft.replace(R.id.parent, gridFragmentLayout);
            findViewById(R.id.btn_grid).setVisibility(View.GONE);
            findViewById(R.id.btn_sort).setVisibility(View.VISIBLE);
