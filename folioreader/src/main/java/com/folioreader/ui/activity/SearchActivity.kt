...
class SearchActivity : AppCompatActivity(), OnItemClickListener {
    ...
    companion object {
        ...
        const val BUNDLE_SEARCH_LANO = "BUNDLE_SEARCH_LANO"
   ...
   // hlunboi private lateinit var searchAdapter: SearchAdapter
    ...
    private val onItemClickListener = View.OnClickListener { v ->
       ...
       // intent.putExtra(FolioActivity.EXTRA_SEARCH_ITEM, viewHolder.searchLocator as Parcelable)
        ...
        intent.putExtra(BUNDLE_SEARCH_LANO,lano )
            ...
            for (i in 0 until toolbar.childCount) {
                ...
                if (contentDescription == "Collapse") {
                    ...
                    collapseButtonView?.setOnClickListener {
                        Log.v(LOG_TAG, "-> onClick -> collapseButtonView navigateBack")
                        navigateBack()
                    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _laTelna = LabuLaTelna(this, LabuData.get()._currentLabuIndex)
    ...
    override fun onNewIntent(intent: Intent) {
       ...
       /*hlunboi if (intent.hasExtra(BUNDLE_SEARCH_URI)) {
            searchUri = intent.getParcelableExtra(BUNDLE_SEARCH_URI)
        } else {
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                ...
                if (TextUtils.isEmpty(newText)) {
                    ...
                    latel = _laTelna!!.search(newText!!)

                }
                val laTelnaAdapter = LaTelnaAdapter(latel!!, newText!!, false)
                laTelnaAdapter.setOnItemClickListener(onItemClickListener)
                recyclerView.adapter = laTelnaAdapter
        ...
        itemSearch.setOnActionExpandListener(object : MenuItem.OnActionExpandListener {
            ...
            override fun onMenuItemActionCollapse(item: MenuItem?): Boolean {
                Log.v(LOG_TAG, "-> onMenuItemActionCollapse navigateBack")
                navigateBack()
                return false
            }
        })
    ...
    override fun onItemClick(
       ...
       /* hlunboi if (adapter is SearchAdapter) {
